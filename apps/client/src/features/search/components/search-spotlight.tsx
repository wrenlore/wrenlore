...
import { useAiSearch } from "@/wrenlore/ai/hooks/use-ai-search.ts";
import { SearchResultItem } from "./search-result-item.tsx";
import { AiSearchResult } from "@/wrenlore/ai/components/ai-search-result.tsx";
import { useHasFeature } from "@/wrenlore/hooks/use-feature";
          ...
          {isAiMode ? (
            <>
              ...
              {query.length > 0 && !isAiLoading && !aiSearchResult && (
                <Spotlight.Empty>{t("Press Ask to search workspace sources.")}</Spotlight.Empty>
              )}
            </>
          ) : (
            <>
