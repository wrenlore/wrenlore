...
export interface AiModels {
  capabilityFlags: Generated<Json>;
  createdAt: Generated<Timestamp>;
...
export interface AiTaskRoutes {
  createdAt: Generated<Timestamp>;
  id: Generated<string>;
  modelId: string;
  routeOptions: Generated<Json>;
  taskClass: string;
  updatedAt: Generated<Timestamp>;
  workspaceId: string;
}
...
export interface UserMfaRecoveryCodes {
  codeHash: string;
  createdAt: Generated<Timestamp>;
  id: Generated<string>;
...
export interface DB {
  ...
  spaces: Spaces;
  userMfa: UserMfa;
  userMfaRecoveryCodes: UserMfaRecoveryCodes;
  users: Users;
