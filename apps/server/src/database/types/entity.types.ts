...
// AI Providers
export type AiProvider = Selectable<_AiProviders>;
export type InsertableAiProvider = Insertable<_AiProviders>;
export type UpdatableAiProvider = Updateable<Omit<_AiProviders, 'id'>>;

// AI Models
export type AiModel = Selectable<_AiModels>;
export type InsertableAiModel = Insertable<_AiModels>;
export type UpdatableAiModel = Updateable<Omit<_AiModels, 'id'>>;

// AI Task Routes
export type AiTaskRoute = Selectable<_AiTaskRoutes>;
export type InsertableAiTaskRoute = Insertable<_AiTaskRoutes>;
export type UpdatableAiTaskRoute = Updateable<Omit<_AiTaskRoutes, 'id'>>;
